...
<p align="center">
  ...
  <a href="https://github.com/Mavlan/Torrent404/releases/tag/v0.2.0"><img alt="版本 0.2.0" src="https://img.shields.io/badge/version-0.2.0-c8f36a?style=flat-square&labelColor=07110f"></a>
...
v0.2.0 有意保持克制：提供多来源搜索、Magnet 与本地 `.torrent` 文件直接添加、可靠的任务控制、重启恢复，以及必须由用户主动开启的做种。
...
从 [GitHub Releases](../../releases) 下载 v0.2.0 安装包：

- `Torrent404_0.2.0_x64-setup.exe` — NSIS 安装包
- `Torrent404_0.2.0_x64_zh-CN.msi` — zh-CN MSI 安装包
...
v0.2.0 安装包尚未进行代码签名，因此 Windows SmartScreen 可能显示“未知发布者”提示。继续前请确认安装包来源。
...
Torrent404 v0.2.0 不包含 HTTP/HTTPS 下载、`.torrent` 拖拽导入、托管式搜索代理、匿名网络层、自动做种、分享率规则、Torrent 创建/导出、海报元数据服务或 Provider 插件 SDK。当前发行目标是 Windows x64。
