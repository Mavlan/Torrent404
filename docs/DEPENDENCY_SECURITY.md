...
| Vulnerability package/node | Dependency path | Severity | Advisory / CVE | Affected / patched | Production and bundle | Reachability in TorLink Desktop threat model | Recommended fix |
|---|---|---:|---|---|---|---|---|
