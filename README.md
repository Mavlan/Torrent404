...
<p align="center">
  ...
  <a href="https://github.com/Mavlan/Torrent404/releases/tag/v0.2.0"><img alt="Version 0.2.0" src="https://img.shields.io/badge/version-0.2.0-c8f36a?style=flat-square&labelColor=07110f"></a>
...
Download a v0.2.0 artifact from [GitHub Releases](../../releases):

- `Torrent404_0.2.0_x64-setup.exe` — NSIS installer
- `Torrent404_0.2.0_x64_zh-CN.msi` — zh-CN MSI installer
...
v0.2.0 installers are not code-signed. Windows SmartScreen may therefore show an unknown-publisher warning; verify the artifact source before continuing.
...
Torrent404 v0.2.0 does not include HTTP/HTTPS downloads, drag-and-drop `.torrent` imports, a hosted search proxy, anonymity layer, automatic seeding, ratio rules, torrent creation/export, metadata/poster services, or a provider plugin SDK. The current release target is Windows x64.
