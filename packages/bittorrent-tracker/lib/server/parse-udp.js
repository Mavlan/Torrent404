...
// `ip@2.0.1` has no patched release for GHSA-2p57-rm9w-gvfp. The upstream
// tracker only needs this narrow conversion for the optional IPv4 field in an
// incoming UDP announce, so avoid the vulnerable package entirely.
const ipv4FromUInt32 = value => [
  value >>> 24,
  (value >>> 16) & 0xff,
  (value >>> 8) & 0xff,
  value & 0xff
